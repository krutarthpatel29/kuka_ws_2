...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value='kr360_description',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'controllers_file',
            default_value='kr360_controllers.yaml',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'description_file',
            default_value='kr360.config.xacro',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'robot_controller',
            default_value='kr360_arm_controller',
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(description_package), 'rviz', 'kr360.rviz']
    )
    ...
    kr360_simulation_world = PathJoinSubstitution(
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={'verbose': 'false', 'world': kr360_simulation_world}.items(),
    ...
    spawn_entity = Node(
        ...
        arguments=['-topic', [namespace, 'robot_description'], '-entity', [namespace, 'kr360']],
        output='screen',
        condition=IfCondition(use_sim),
    )
